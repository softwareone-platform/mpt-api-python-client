...
The platform issues the tokens; the client only reads claims such as ``exp`` to decide
when to refresh proactively. Signature verification is intentionally not performed.
"""
