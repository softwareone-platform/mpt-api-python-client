...
class ServiceSharedBase[Client, ModelClass: Model]:
    """Client base."""
...
class ServiceBase[ModelClass: Model](ServiceSharedBase[HTTPClient, ModelClass]):
...
class AsyncServiceBase[ModelClass: Model](ServiceSharedBase[AsyncHTTPClient, ModelClass]):
    """Immutable Base client for RESTful resource collections.
    ...
    async def create(self, resource_data: dict[str, Any]) -> ModelClass:
        """Create a new resource using `POST /endpoint`.
