from mpt_api_client.http.service import AsyncServiceBase, ServiceBase
...
class OrdersService(ServiceBase[Order], OrdersServiceConfig):
    """Orders client."""
...
class AsyncOrdersService(AsyncServiceBase[Order], OrdersServiceConfig):
    """Async Orders client."""
