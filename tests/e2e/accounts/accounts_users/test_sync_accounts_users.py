...
@pytest.fixture
def users(mpt_vendor, account_id):  # noqa: WPS204
...
def test_get_account_user_by_id(mpt_vendor, user_id, account_id):  # noqa: AAA01
    """Test retrieving an account user by ID."""
    users_obj = mpt_vendor.accounts.accounts.users(account_id=account_id)
    account_user = users_obj.get(user_id)
    assert account_user is not None


def test_list_account_users(mpt_vendor, account_id):  # noqa: AAA01
    """Test listing account users."""
    limit = 10

    users_obj = mpt_vendor.accounts.accounts.users(account_id=account_id)
    account_users = users_obj.fetch_page(limit=limit)
...
def test_filter_account_users(mpt_vendor, user_id, account_id):  # noqa: AAA01
...
def test_create_account_user(created_account_user):  # noqa: AAA01
    """Test creating an account user."""
    account_user_data = created_account_user()
    assert account_user_data is not None


def test_delete_account_user(mpt_vendor, created_account_user, account_id):  # noqa: AAA01
    """Test deleting an account user."""
    account_user_data = created_account_user()
    users_obj = mpt_vendor.accounts.accounts.users(account_id=account_id)
    users_obj.delete(account_user_data.id)


def test_update_account_user(  # noqa: AAA01
    mpt_vendor,
    ...
    updated_account_user = users_obj.update(
...
def test_account_user_resend_invite(  # noqa: AAA01
    mpt_vendor,
    created_account_user,
    account_id,
):
    ...
    account_user_data = created_account_user()
    users_obj = mpt_vendor.accounts.accounts.users(account_id=account_id)
    resend_invite = users_obj.resend_invite(account_user_data.id)
...
def test_account_user_group_update(  # noqa: AAA01
    mpt_vendor,
    created_account_user,
    created_user_group,
    account_id,
    ...
    updated_account_user_group = users_obj.groups(user_id=created_account_user_data.id).update(
        update_user_group_data
    )
    assert updated_account_user_group is not None


def test_account_user_group_delete(  # noqa: AAA01
    mpt_vendor,
    created_account_user,
    created_user_group,
    account_id,
    ...
    users_obj.groups(user_id=created_account_user_data.id).delete(created_user_group.id)
