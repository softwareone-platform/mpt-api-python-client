...
@pytest.fixture
async def async_created_licensee(async_mpt_client, licensee, licensee_account_id, account_icon):
...
async def test_filter_licensees(async_mpt_client, licensee_id):
    ...
    licensees = [filtered_licensee async for filtered_licensee in async_filtered_licensees.iterate()]
...
async def test_update_licensee(
    async_mpt_client, licensee, account_icon, async_created_licensee
):
...
async def test_update_licensee_not_found(
    async_mpt_client, licensee, account_icon, invalid_licensee_id
):
